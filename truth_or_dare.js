...
function dare(taskNum) {
  switch (taskNum) {
    ...
    case 9:
      return "Sing song for whome next to you {It should be romatic song}.🎶🎵";
    case 10:
...
function truthOrDare(taskNum) {
  ...
  if (input === 'Truth') {
    console.log('\n----------------------------------------------------------');
    console.log('Your Truth Task is ☞ "' + truth(taskNum) + '"');
    console.log('----------------------------------------------------------');
  ...
  if (input === 'Dare') {
    console.log('\n----------------------------------------------------------');
    console.log('Your Dare Task is ☞ "' + dare(taskNum) + '"');
    console.log('----------------------------------------------------------');

    return prompt('\n\t**** Press "Enter" After Dare Task completion !!');
  } else {
    console.log('\n------------------------------');
